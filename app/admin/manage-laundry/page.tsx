                ...
                <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/30 border border-red-300 dark:border-red-700 rounded-lg flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-red-600 dark:text-red-400 mt-0.5">
                      This service needs ~{waterNeeded}L, but only {drumStatus?.remainingLiters ?? 0}L ({drumStatus?.drumsRemaining ?? 0} drums) remain. Please refill the drums before proceeding.
                    </p>
                  </div>
                </div>
              )}
